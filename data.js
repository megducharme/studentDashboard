// 1. User names & pictures
// 2. Most recent commit (time of commit)
// 3. Total repositories per user
// 4. List of languages per repository per user
        ...
        $.ajax({
            ...
            .then(students => {
                ...
                Promise.all(arrayOfPromises).then(responses => {
                    ...
                    let allStudentz = JSON.stringify(allStudents)
                    localStorage.setItem("student-data", allStudentz)
